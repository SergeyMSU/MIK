	...
	real(8), parameter :: par_nat_TS = lock_move * 0.3 * 0.002_8 ! 0.002_8 !0.0000001_8 !0.003_8                ! Коэффициент натяжения ударной волны  0.002
	...
	real(8), parameter :: koef1 = lock_move * 0.1 * 0.2_8! 0.3      ! Коэффициент запаздывания скорости ударной волны
