	...
	logical, parameter :: par_null_bn = .True.          ! Обнулять ли bn на контакте
	 ...
	 real(8), parameter :: par_null_bn_x = -180.0_8   ! От какоко расстояния включаем вычитание bn
	...
	real(8), parameter :: par_nat_HP = lock_move * 100.0 *  1.5_8 ! 0.1  0.8                 ! Коэффициент натяжения контакта  0.0001
    ...
    real(8), parameter :: koef2 = lock_move * 0.1_8 ! 1.0  0.5  0.01
