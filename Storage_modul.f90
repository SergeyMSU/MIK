    ...
    integer(4), allocatable :: gl_Gran_info(:)         ! (:) классификатор грани (см. схему)  для расчёта какие грани пропускать для внутренней сферы (бредово сделано, надо переделывать)
