	...
	logical, parameter :: par_null_bn = .False.          ! Обнулять ли bn на контакте
	...
	real(8), parameter :: par_nat_TS = 0.003_8 ! 0.002_8 !0.0000001_8 !0.003_8                ! Коэффициент натяжения ударной волны  0.002
	real(8), parameter :: par_nat_HP = 0.0 * 0.8_8 ! 1.0                 ! Коэффициент натяжения контакта  0.0001
	real(8), parameter :: par_nat_BS = 0.0 * 0.00004_8                ! Коэффициент натяжения внешней ударной волны 0.0002
	
	real(8), parameter :: koef1 = 0.0 * 0.4_8! 0.3      ! Коэффицинт запаздывания скорости ударной волны
    real(8), parameter :: koef2 = 0.1 * 1.0_8 ! 1.0  0.5
    real(8), parameter :: koef3 = 0.1 * 0.7_8   ! 0.3
	...
	real(8) :: par_al1 = 1.0   ! Для сгущения сетки по углу (цилиндрическому)
	...
	real(8), parameter :: par_velocity_in(19) = (/ 630.2394085106936, 640.4105750846768, 630.8115381444824, &
		...
		617.5387454952307, 626.1195404367945, 621.216192571027/)  ! * 0.0963179
