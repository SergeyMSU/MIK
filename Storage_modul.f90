	...
	logical, parameter :: par_null_bn = .True.          ! Обнулять ли bn на контакте
	 ...
	 real(8), parameter :: par_null_bn_x = -250.0_8   ! От какоко расстояния включаем вычитание bn
	...
	real(8), parameter :: par_nat_HP = lock_move * 0.8_8 ! 0.1  0.8                 ! Коэффициент натяжения контакта  0.0001
    ...
    real(8), parameter :: koef2 = lock_move * 3.0_8 ! 1.0  0.5  0.01
	...
	NAMELIST /SETKA_PARAM/ par_n_TS, par_n_HP, par_n_BS, par_n_END, par_n_IA, par_n_IB, par_triple_point, par_l_phi, &
		...
		par_R_inner, par_kk1, par_kk12, par_kk2, par_kk3, par_kk31, par_kk13, par_al1
