	...
	real(8), parameter :: par_nat_HP = 0.0002                ! Коэффициент натяжения контакта  0.0002
    ...
    integer :: par_m_A = 30      ! Количество лучей A в плоскости
    integer :: par_m_BC = 18      ! Количество лучей B/C в плоскости
    integer :: par_m_O = 17      ! Количество лучей O в плоскости
    integer :: par_m_K = 7      ! Количество лучей K в плоскости
    ...
    !integer :: par_n_TS =  3! 3                 ! Количество точек до TS (TS включается)
    !integer :: par_n_HP =  6! 4                 ! Количество точек HP (HP включается)  всё от 0 считается
    !integer :: par_n_BS =  9! 5                 ! Количество точек BS (BS включается)
    !integer :: par_n_END = 12! 6                ! Количество точек до конца сетки (конец включается)
