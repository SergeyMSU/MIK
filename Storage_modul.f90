	...
	real(8), parameter :: par_nat_TS = 0.003_8 !0.003_8                ! Коэффициент натяжения ударной волны  0.002
	real(8), parameter :: par_nat_HP = 0.00002_8 !0.00005_8               ! Коэффициент натяжения контакта  0.0001
	real(8), parameter :: par_nat_BS = 0.0002_8                ! Коэффициент натяжения внешней ударной волны 0.0002
	
	real(8), parameter :: koef1 = 0.3_8! 0.3      ! Коэффицинт запаздывания скорости ударной волны
