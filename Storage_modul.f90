	...
	real(8), parameter :: par_nat_TS = 0.1 * 0.004_8 ! 0.002_8 !0.0000001_8 !0.003_8                ! Коэффициент натяжения ударной волны  0.002
	...
	real(8), parameter :: koef1 = 0.1 * 0.4_8! 0.3      ! Коэффицинт запаздывания скорости ударной волны
    real(8), parameter :: koef2 = 0.1 * 1.0_8 ! 1.0  0.5  0.01
	...
	real(8) :: par_kk13 = 1.0_8     ! Степень сгущения точек в головной области во внешнем ударном слое
