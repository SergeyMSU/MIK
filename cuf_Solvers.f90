...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 !           return
	...
	if (.False.) then!(par_null_bn == .True. .and. gl_Gran_center2(1, gr, now) >= 0.0) then
	...
	!end if
            ...
            if (.False.) then!(gl_Gran_type(gr) == 2 .and. gl_Gran_center2(1, gr, now) >= 0.0) then ! Для гелиопаузы особая процедура
